...
```{r}
chopped <- chop(x, c(2, 5, 8), lbl_dash(first = "< 2", last = "9+"))
data.frame(x, chopped)
```
...
* `lbl_discrete()`, for integer data
* `lbl_endpoint()`, use left endpoints as labels
* `lbl_manual()`, specify labels manually
