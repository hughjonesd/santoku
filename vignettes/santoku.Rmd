...
Santoku is a package for cutting data into intervals. It provides a replacement
for base R's `cut()` function.
...
Or, provide labels as names to the `breaks` argument:
